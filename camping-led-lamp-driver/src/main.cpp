...
// NEW: track whether we've already signaled an overheat condition with the flash pattern
bool overheatFlashDone = false;
...
// NEW: Full-screen overheat message (avoids overlapping headers)
void drawOverheatScreen() {
    u8g2.firstPage();
    do {
